...
describe("Testando a UserBusiness", () => {
    ...
    test("Email já cadastrado", async () => {
        expect.assertions(2)
    ...
    test("O parameteo 'name' não é uma string", async () => {
        expect.assertions(2)
    ...
    test("Email em formato inválido", async () => {
        expect.assertions(2)

        try {
            const input: ISignupInputDTO = {
                email: "astrodev.labenu",
                name: "Astrodev",
                password: "123456"
            }
    ...
    test("Erro de senha incorreta", async () => {
        expect.assertions(2)
        try {
            const input: ILoginInputDTO = {
                email: "astrodev@gmail.com",
